...
This directory contains a ready-made Terraform configuration and an [example terraform.tfvars file](https://github.com/hashicorp/terraform-aws-terraform-enterprise-hvd/blob/0.4.0/examples/main/terraform.tfvars.example) for deploying this module.
