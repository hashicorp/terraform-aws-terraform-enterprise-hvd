...
| <a name="input_tfe_admin_console_port"></a> [tfe\_admin\_console\_port](#input\_tfe\_admin\_console\_port) | Port the TFE Admin Console listens on for HTTPS traffic. This value is used for both the host and container port. | `number` | `9200` | no |
