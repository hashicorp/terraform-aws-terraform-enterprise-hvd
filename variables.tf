...
variable "container_runtime" {
  type        = string
  description = "Container runtime to use for TFE. Supported values are 'docker'."
  default     = "docker"

  validation {
    condition     = var.container_runtime == "docker"
    error_message = "Supported values are `docker`."
  }
}
